...
txt[which(txt$names == "MIT"), 2]          <- txt[which(txt$names == "MIT"), 2] + -0.65
txt[which(txt$names == "MIT"), 3]          <- txt[which(txt$names == "MIT"), 3] + 0.25
txt[which(txt$names == "Northeastern"), 2] <- txt[which(txt$names == "Northeastern"), 2] + 0.75
txt[which(txt$names == "Northeastern"), 3] <- txt[which(txt$names == "Northeastern"), 3] + 0.35
txt[which(txt$names == "Tufts"), 2]        <- txt[which(txt$names == "Tufts"), 2] + 0.5
...
## Seperate Boston-Cambridge Points
data[which(data$names == "MIT"), 2] <- data[which(data$names == "MIT"), 2] + -0.15 
data[which(data$names == "MIT"), 3] <- data[which(data$names == "MIT"), 3] + 0.15
data[which(data$names == "Harvard"), 2]      <- data[which(data$names == "Harvard"), 2] + -0.15
data[which(data$names == "Northeastern"), 2] <- data[which(data$names == "Northeastern"), 2] + 0.15
data[which(data$names == "Northeastern"), 3] <- data[which(data$names == "Northeastern"), 3] + 0.15
data[which(data$names == "Tufts"), 2] <- data[which(data$names == "Tufts"), 2] + 0.15
...
ggsave("East-Coast_Universities.png", NE.map, width = 11, height = 11, dpi = 450)
